...
const Course = () => {
  ...
  const navigator = useNavigate();
    ...
    //         try{
    //          const response=await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/admin/${data}/approve/student/:studentID`)
  ...
  useEffect(() => {
    const fetchCourseRequests = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/admin/${data}/approve/course`);
  ...
  //   console.log(id);
  //   try {
  //     const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/admin/${data}/approve/course/${id}`, {
  //       method: 'POST',
  //       headers: {
  ...
  const handleAccept = async (id, info) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/admin/${data}/approve/course/${id}`, {
        Isapproved: true,
        email: info.Email,
        Firstname: info.enrolledteacher,
      }, {
