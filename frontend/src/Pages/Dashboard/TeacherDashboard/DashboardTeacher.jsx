...
function DashboardTeacher() {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        const response = await apiCall(`/api/Teacher/TeacherDocument/${ID}`, {
          method: "GET",
        });
  ...
  useEffect(()=>{
    const getData = async()=>{
      const response = await apiCall('/api/teacher/teacherdocuments',{
        method: 'POST',
        credentials: "include",
  ...
  useEffect(() => {
    const getAmount = async () => {
      try {
        const response = await apiCall(`/api/payment/teacher/${ID}/balance`, {
          method: "POST",
        });
  ...
  useEffect(() => {
    const getCourses = async () => {
      try {
        const response = await apiCall(`/api/course/Teacher/${ID}/enrolled`, {
          method: "GET",
        });
