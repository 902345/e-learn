...
function search() {
    ...
    let SearchTeacher = async()=>{
        ...
        let Data = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/course/${Subject}`)
    ...
    const openTeacherDec = async(id,fname,lname,sub)=>{
        ...
        const data = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/teacher/teacherdocuments`, {
            method: 'POST',
            credentials: "include",
            headers: {
